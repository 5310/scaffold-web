...
var Stream = (function () {
     ...
     * @returns {Stream}
     */
    Stream.prototype[symbolObservable.default] = function () {
        return this;
    };
    /**
    ...
    Stream.from = function (input) {
        if (typeof input[symbolObservable.default] === 'function')
...
function makeSinkProxies(drivers) {
    ...
    for (var name_1 in drivers) {
        if (drivers.hasOwnProperty(name_1)) {
            sinkProxies[name_1] = xs.createWithMemory();
        }
    }
    return sinkProxies;
}
...
var thunk_1 = createCommonjsModule(function (module, exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
var DocumentDOMSource_1 = createCommonjsModule(function (module, exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
var DocumentDOMSource = (function () {
    ...
    DocumentDOMSource.prototype.elements = function () {
        var out = adapt_1.adapt(xstream.default.of(document));
...
var BodyDOMSource_1 = createCommonjsModule(function (module, exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
var BodyDOMSource = (function () {
    ...
    BodyDOMSource.prototype.elements = function () {
        var out = adapt_1.adapt(xstream.default.of(document.body));
        out._isCycleSource = this._name;
        return out;
    };
...
var ScopeChecker_1 = createCommonjsModule(function (module, exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
var ElementFinder_1 = createCommonjsModule(function (module, exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
var ElementFinder = (function () {
    ...
    ElementFinder.prototype.call = function (rootElement) {
        ...
        var selector = utils.getSelectors(namespace);
        if (!selector) {
            return rootElement;
        }
        var fullScope = utils.getFullScope(namespace);
        ...
        var topNode = fullScope
            ...
            : rootElement;
        var topNodeMatchesSelector = !!fullScope && !!selector && matchesSelector.matchesSelector(topNode, selector);
...
var isolate = createCommonjsModule(function (module, exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });


function totalIsolateSource(source, scope) {
    return source.select(utils.SCOPE_PREFIX + scope);
}
...
function isolateSource(source, scope) {
    ...
    else if (utils.isClassOrId(scope)) {
...
function totalIsolateSink(sink, fullScope) {
    return sink.map(function (node) {
        ...
        if (typeof node.key === 'undefined') {
            node.key = utils.SCOPE_PREFIX + fullScope;
        }
        return node;
    });
}
...
var EventDelegator_1 = createCommonjsModule(function (module, exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
var EventDelegator = (function () {
    ...
    EventDelegator.prototype.createDestination = function (namespace) {
        ...
        var id = this._lastId++;
        var selector = utils.getSelectors(namespace);
        var scopeChecker = new ScopeChecker_1.ScopeChecker(utils.getFullScope(namespace), this.isolateModule);
        var subject = xstream.default.create({
            start: function () { },
            stop: function () {
    ...
    EventDelegator.prototype.capture = function (ev) {
        ...
        for (var i = 0; i < n; i++) {
            ...
            if (matchesSelector.matchesSelector(ev.target, dest.selector)) {
                dest.subject._n(ev);
            }
        }
    };
    ...
    EventDelegator.prototype.matchEventAgainstDestinations = function (el, ev) {
        ...
        for (var i = 0; i < n; i++) {
            ...
            if (matchesSelector.matchesSelector(el, dest.selector)) {
...
var MainDOMSource_1 = createCommonjsModule(function (module, exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
var MainDOMSource = (function () {
    function MainDOMSource(_rootElement$, _sanitation$, _namespace, _isolateModule, _delegators, _name) {
        ...
        this._name = _name;
        this.isolateSource = isolate.isolateSource;
        this.isolateSink = function (sink, scope) {
            if (scope === ':root') {
                return sink;
            }
            else if (utils.isClassOrId(scope)) {
                return isolate.siblingIsolateSink(sink, scope);
            }
            else {
                var prevFullScope = utils.getFullScope(_this._namespace);
                var nextFullScope = [prevFullScope, scope].filter(function (x) { return !!x; }).join('-');
                return isolate.totalIsolateSink(sink, nextFullScope);
            }
        };
    }
...
var selectorParser_2 = selectorParser;


var selectorParser_1 = {
	selectorParser: selectorParser_2
};
...
var classNameFromVNode_2 = classNameFromVNode;


var classNameFromVNode_1 = {
	classNameFromVNode: classNameFromVNode_2
};

var VNodeWrapper_1 = createCommonjsModule(function (module, exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
var VNodeWrapper = (function () {
    ...
    VNodeWrapper.prototype.call = function (vnode) {
        if (utils.isDocFrag(this.rootElement)) {
...
var modules_1 = createCommonjsModule(function (module, exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });

exports.ClassModule = _class.default;

exports.PropsModule = props.default;

exports.AttrsModule = attributes.default;

exports.StyleModule = style.default;

exports.DatasetModule = dataset.default;
var modules = [
    style.default,
    _class.default,
    props.default,
...
var objIsPrototypOf = Object.prototype.isPrototypeOf;
...
var shim$9 = function (object) {
	return keys$2(isValue(object) ? Object(object) : object);
};

var keys = isImplemented$10()
	? Object.keys
	: shim$9;
...
defineProperties$2(Iterator.prototype, assign({
	constructor: d_1(Iterator),
	_next: d_1(function () {
		var i;
	...
	next: d_1(function () { return this._createResult(this._next()); }),
	_createResult: d_1(function (i) {
		if (i === undefined) return { done: true, value: undefined };
		return { done: false, value: this._resolve(i) };
	}),
	_resolve: d_1(function (i) { return this.__list__[i]; }),
	...
	toString: d_1(function () { return '[object Iterator]'; })
}, autoBind({
...
defineProperty$2(Iterator.prototype, es6Symbol.iterator, d_1(function () {
	return this;
}));
defineProperty$2(Iterator.prototype, es6Symbol.toStringTag, d_1('', 'Iterator'));
...
ArrayIterator.prototype = Object.create(es6Iterator.prototype, {
	constructor: d_1(ArrayIterator),
	_resolve: d_1(function (i) {
		if (this.__kind__ === 'value') return this.__list__[i];
		if (this.__kind__ === 'key+value') return [i, this.__list__[i]];
		return i;
	}),
	toString: d_1(function () { return '[object Array Iterator]'; })
});
});
...
StringIterator.prototype = Object.create(es6Iterator.prototype, {
	constructor: d_1(StringIterator),
	_next: d_1(function () {
		if (!this.__list__) return;
	...
	toString: d_1(function () { return '[object String Iterator]'; })
});
});
...
var es6Map = isImplemented() ? Map : polyfill;

var IsolateModule_1 = createCommonjsModule(function (module, exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });

var IsolateModule = (function () {
    function IsolateModule() {
        this.elementsByFullScope = new es6Map();
        this.delegatorsByFullScope = new es6Map();
...
var makeDOMDriver_1 = createCommonjsModule(function (module, exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
function dropCompletion(input) {
    return xstream.default.merge(input, xstream.default.never());
}
...
function makeDOMDriver(container, options) {
    ...
    var patch = snabbdom.init([isolateModule.createModule()].concat(modules));
    var rootElement = utils.getValidNode(container) || document.body;
    var vnodeWrapper = new VNodeWrapper_1.VNodeWrapper(rootElement);
    var delegators = new es6Map();
    makeDOMDriverInputGuard(modules);
    function DOMDriver(vnode$, name) {
        if (name === void 0) { name = 'DOM'; }
        domDriverInputGuard(vnode$);
        var sanitation$ = xstream.default.create();
        var rootElement$ = xstream.default
            .merge(vnode$.endWhen(sanitation$), sanitation$)
            .map(function (vnode) { return vnodeWrapper.call(vnode); })
            .fold(patch, tovnode.toVNode(rootElement))
            .drop(1)
...
var mockDOMSource_1 = createCommonjsModule(function (module, exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
var MockedDOMSource = (function () {
    function MockedDOMSource(_mockConfig) {
        ...
        if (_mockConfig['elements']) {
            ...
            this._elements = adapt_1.adapt(xstream.default.empty());
        }
    }
    ...
    MockedDOMSource.prototype.events = function (eventType, options) {
        ...
        var out = adapt_1.adapt(streamForEventType || xstream.default.empty());
        out._isCycleSource = 'MockedDOM';
        return out;
    };
...
var hyperscriptHelpers = createCommonjsModule(function (module, exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
exports.svg = hyperscriptHelpers.default.svg;
exports.a = hyperscriptHelpers.default.a;
exports.abbr = hyperscriptHelpers.default.abbr;
exports.address = hyperscriptHelpers.default.address;
exports.area = hyperscriptHelpers.default.area;
exports.article = hyperscriptHelpers.default.article;
exports.aside = hyperscriptHelpers.default.aside;
exports.audio = hyperscriptHelpers.default.audio;
exports.b = hyperscriptHelpers.default.b;
exports.base = hyperscriptHelpers.default.base;
exports.bdi = hyperscriptHelpers.default.bdi;
exports.bdo = hyperscriptHelpers.default.bdo;
exports.blockquote = hyperscriptHelpers.default.blockquote;
exports.body = hyperscriptHelpers.default.body;
exports.br = hyperscriptHelpers.default.br;
exports.button = hyperscriptHelpers.default.button;
exports.canvas = hyperscriptHelpers.default.canvas;
exports.caption = hyperscriptHelpers.default.caption;
exports.cite = hyperscriptHelpers.default.cite;
exports.code = hyperscriptHelpers.default.code;
exports.col = hyperscriptHelpers.default.col;
exports.colgroup = hyperscriptHelpers.default.colgroup;
exports.dd = hyperscriptHelpers.default.dd;
exports.del = hyperscriptHelpers.default.del;
exports.dfn = hyperscriptHelpers.default.dfn;
exports.dir = hyperscriptHelpers.default.dir;
exports.div = hyperscriptHelpers.default.div;
exports.dl = hyperscriptHelpers.default.dl;
exports.dt = hyperscriptHelpers.default.dt;
exports.em = hyperscriptHelpers.default.em;
exports.embed = hyperscriptHelpers.default.embed;
exports.fieldset = hyperscriptHelpers.default.fieldset;
exports.figcaption = hyperscriptHelpers.default.figcaption;
exports.figure = hyperscriptHelpers.default.figure;
exports.footer = hyperscriptHelpers.default.footer;
exports.form = hyperscriptHelpers.default.form;
exports.h1 = hyperscriptHelpers.default.h1;
exports.h2 = hyperscriptHelpers.default.h2;
exports.h3 = hyperscriptHelpers.default.h3;
exports.h4 = hyperscriptHelpers.default.h4;
exports.h5 = hyperscriptHelpers.default.h5;
exports.h6 = hyperscriptHelpers.default.h6;
exports.head = hyperscriptHelpers.default.head;
exports.header = hyperscriptHelpers.default.header;
exports.hgroup = hyperscriptHelpers.default.hgroup;
exports.hr = hyperscriptHelpers.default.hr;
exports.html = hyperscriptHelpers.default.html;
exports.i = hyperscriptHelpers.default.i;
exports.iframe = hyperscriptHelpers.default.iframe;
exports.img = hyperscriptHelpers.default.img;
exports.input = hyperscriptHelpers.default.input;
exports.ins = hyperscriptHelpers.default.ins;
exports.kbd = hyperscriptHelpers.default.kbd;
exports.keygen = hyperscriptHelpers.default.keygen;
exports.label = hyperscriptHelpers.default.label;
exports.legend = hyperscriptHelpers.default.legend;
exports.li = hyperscriptHelpers.default.li;
exports.link = hyperscriptHelpers.default.link;
exports.main = hyperscriptHelpers.default.main;
exports.map = hyperscriptHelpers.default.map;
exports.mark = hyperscriptHelpers.default.mark;
exports.menu = hyperscriptHelpers.default.menu;
exports.meta = hyperscriptHelpers.default.meta;
exports.nav = hyperscriptHelpers.default.nav;
exports.noscript = hyperscriptHelpers.default.noscript;
exports.object = hyperscriptHelpers.default.object;
exports.ol = hyperscriptHelpers.default.ol;
exports.optgroup = hyperscriptHelpers.default.optgroup;
exports.option = hyperscriptHelpers.default.option;
exports.p = hyperscriptHelpers.default.p;
exports.param = hyperscriptHelpers.default.param;
exports.pre = hyperscriptHelpers.default.pre;
exports.progress = hyperscriptHelpers.default.progress;
exports.q = hyperscriptHelpers.default.q;
exports.rp = hyperscriptHelpers.default.rp;
exports.rt = hyperscriptHelpers.default.rt;
exports.ruby = hyperscriptHelpers.default.ruby;
exports.s = hyperscriptHelpers.default.s;
exports.samp = hyperscriptHelpers.default.samp;
exports.script = hyperscriptHelpers.default.script;
exports.section = hyperscriptHelpers.default.section;
exports.select = hyperscriptHelpers.default.select;
exports.small = hyperscriptHelpers.default.small;
exports.source = hyperscriptHelpers.default.source;
exports.span = hyperscriptHelpers.default.span;
exports.strong = hyperscriptHelpers.default.strong;
exports.style = hyperscriptHelpers.default.style;
exports.sub = hyperscriptHelpers.default.sub;
exports.sup = hyperscriptHelpers.default.sup;
exports.table = hyperscriptHelpers.default.table;
exports.tbody = hyperscriptHelpers.default.tbody;
exports.td = hyperscriptHelpers.default.td;
exports.textarea = hyperscriptHelpers.default.textarea;
exports.tfoot = hyperscriptHelpers.default.tfoot;
exports.th = hyperscriptHelpers.default.th;
exports.thead = hyperscriptHelpers.default.thead;
exports.title = hyperscriptHelpers.default.title;
exports.tr = hyperscriptHelpers.default.tr;
exports.u = hyperscriptHelpers.default.u;
exports.ul = hyperscriptHelpers.default.ul;
exports.video = hyperscriptHelpers.default.video;

});

var lib_3 = lib$2.makeDOMDriver;
var lib_33 = lib$2.div;
var lib_43 = lib$2.h1;
var lib_52 = lib$2.hr;
var lib_57 = lib$2.input;
var lib_61 = lib$2.label;

const main$$1 = sources => {
  const input$ = sources.DOM.select('.field').events('input');

  const name$ = input$.map(ev => ev.target.value).startWith('');

  const vdom$ = name$.map(name => lib_33([lib_61('Name:'), lib_57('.field', { attrs: { type: 'text' } }), lib_52(), lib_43('Hello ' + name)]));

  return { DOM: vdom$ };
};

run(main$$1, { DOM: lib_3('#app-container') });
